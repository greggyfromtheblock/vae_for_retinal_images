...
class Encoder(nn.Module):
    def __init__(self, z=32):
        ...
        self.conv_layers = nn.Sequential(
            ...
            *conv_block(3, 15, kernel_size=5, stride=1, padding=2),  # (384-5+2*2)//1 + 1 = 384  > Max-Pooling: 384/2=192
            # -> (376-5+2*2)//1 + 1 = 376  --> Max-Pooling: 376/2 = 188
            *conv_block(15, 50, kernel_size=5, stride=1, padding=2),  # (192-5+2*2)//1 + 1 = 192  > Max-Pooling: 190/2=96
            # -> (188-5+2*2)//1 + 1 = 188  --> Max-Pooling: 188/2 = 94
            *conv_block(50, 100, kernel_size=5, padding=2),   # New "Image" Size:  48x47
            *conv_block(100, 150, padding=1),  # New "Image" Size:  24x23
            *conv_block(150, 200, padding=0, padding_max_pooling=1),  # New "Image" Size:  11x10
            *conv_block(200, 300, padding=0, padding_max_pooling=0),  # New "Image" Size:  5x4
            *conv_block(300, 500, padding=0, padding_max_pooling=1),  # New "Image" Size:  2x2
        )
        ...
        self.linear_layers = nn.Sequential(
            ...
            *linear_block(512, 256, normalize=True, dropout=0.3),
...
class Decoder(nn.Module):
    def __init__(self, z=32):
        ...
        self.conv_layers = nn.Sequential(
            *conv_block(500, 300, padding=1, size=(5, 4)),
            *conv_block(300, 150, padding=1, size=(11, 10)),
            *conv_block(150, 100, padding=1, size=(24, 23), mode='nearest'),
            *conv_block(100, 75, padding=1, size=(48, 47), mode='nearest'),
            *conv_block(75, 50, padding=1, scale_factor=2),
            *conv_block(50, 25, kernel_size=5, padding=2, scale_factor=2, mode='nearest'),
            *conv_block(25, 15, kernel_size=5, padding=2, scale_factor=2, mode='bilinear'),
            nn.Conv2d(in_channels=15, out_channels=3, kernel_size=1),
        )
