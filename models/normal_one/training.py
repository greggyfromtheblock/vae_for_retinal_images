...
class Encoder(nn.Module):
    def __init__(self, z=32):
        ...
        self.conv_layers = nn.Sequential(
            ...
            *conv_block(32, 48, padding=1),  # New "Image" Size:  24x23
            *conv_block(48, 64, padding=0, padding_max_pooling=1),  # New "Image" Size:  11x10
            *conv_block(64, 80, padding=0, padding_max_pooling=0),  # New "Image" Size:  5x4
            *conv_block(80, 96, padding=0, padding_max_pooling=1),  # New "Image" Size:  2x2
        )
        ...
        self.linear_layers = nn.Sequential(
            *linear_block(96 * 2 * 2, 1024, normalize=True, dropout=0.6),
            *linear_block(1024, 256, dropout=0.4),
...
class Decoder(nn.Module):
    def __init__(self, z=32):
        ...
        self.linear_blocks = nn.Sequential(
            ...
            *linear_block(256, 1024, dropout=0.3),
            *linear_block(1024, 96 * 2 * 2, dropout=0.4),
            nn.ReLU()
        )
        ...
        self.conv_layers = nn.Sequential(
            *conv_block(96, 80, padding=1, size=(5, 4)),
            *conv_block(80, 64, padding=1, size=(11, 10)),
            *conv_block(64, 48, padding=1, size=(24, 23), mode='nearest'),
            *conv_block(48, 32, padding=1, size=(48, 47), mode='nearest'),
            *conv_block(32, 16, padding=1, scale_factor=2),
            *conv_block(16, 8, kernel_size=5, padding=2, scale_factor=2, mode='nearest'),
            nn.Conv2d(in_channels=8, out_channels=3, kernel_size=1),
        )

    def forward(self, latent_vector):
        dec = torch.reshape(self.linear_blocks(latent_vector), (latent_vector.shape[0], 96, 2, 2))
