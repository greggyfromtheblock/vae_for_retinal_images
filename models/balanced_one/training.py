...
class Encoder(nn.Module):
    def __init__(self, z=32):
        ...
        self.conv_layers = nn.Sequential(
            ...
            *conv_block(64, 128, padding=0, padding_max_pooling=1),  # New "Image" Size:  11x10
            *conv_block(128, 256, padding=0, padding_max_pooling=0),  # New "Image" Size:  5x4
            *conv_block(256, 96, padding=0, padding_max_pooling=1),  # New "Image" Size:  2x2
        )
...
class Decoder(nn.Module):
    def __init__(self, z=32):
        ...
        self.conv_layers = nn.Sequential(
            *conv_block(96, 512, padding=1, size=(5, 4)),
            *conv_block(512, 256, padding=1, size=(11, 10)),
            *conv_block(256, 128, padding=1, size=(24, 23), mode='nearest'),
            *conv_block(128, 64, padding=1, size=(48, 47), mode='nearest'),
